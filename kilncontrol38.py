...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.current_temp_label.setGeometry(QtCore.QRect(20, 20, 251, 41))
        font = QtGui.QFont()
        ...
        self.current_target_temp_label = QtWidgets.QLabel(self.centralwidget)
        self.current_target_temp_label.setGeometry(QtCore.QRect(20, 240, 221, 41))
        font = QtGui.QFont()
        font.setFamily("FreeSans")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.current_target_temp_label.setFont(font)
        self.current_target_temp_label.setObjectName("current_target_temp_label")
        ...
        self.ProfilePoint.setGeometry(QtCore.QRect(250, 320, 171, 41))
        font = QtGui.QFont()
        font.setFamily("FreeSans")
        font.setPointSize(14)
        ...
        self.i_slider_value_label.setText(str(float(self.P_Slider.value())/2))
    ...
    def update_i_value(self, value):
        self.pid.setKi(float(value)/2)
        self.i_slider_value_label.setText(str(float(value)/2))
